...
import 'package:yourshopmn/models/model.dart';
import 'package:yourshopmn/utils/navigator.dart';
import 'package:yourshopmn/widgets/board_view.dart';
...
//                colors: [Color(0xCCf857a6), Color(0xCCff5858)])),
  ...
  _alert(BuildContext context) {
    ...
    Alert(
      ...
      type: AlertType.none,
      title: "Үнэгүй оноо",
      desc: "Та цуглуулсан оноогоо худалдан авалт хийхдээ ашиглаж болно.",
      buttons: [
        DialogButton(
          child: Text(
            "Бидэнтэй нэгдэцгээ!!!",
